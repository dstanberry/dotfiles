...
_G.packer_plugins = {
  ...
  ["vim-dirvish"] = {
    loaded = true,
    path = "/home/demaro/.local/share/nvim/site/pack/packer/start/vim-dirvish"
  },
  ["vim-easydir"] = {
    loaded = true,
  ...
  ["vim-matchup"] = {
    loaded = true,
    path = "/home/demaro/.local/share/nvim/site/pack/packer/start/vim-matchup"
  },
  ["vim-ps1"] = {
    loaded = true,
    path = "/home/demaro/.local/share/nvim/site/pack/packer/start/vim-ps1"
  },
  ["vim-repeat"] = {
    loaded = true,
  ...
  ["vim-signify"] = {
    loaded = true,
    path = "/home/demaro/.local/share/nvim/site/pack/packer/start/vim-signify"
  },
  ["vim-snippets"] = {
    loaded = true,
  ...
  ["vim-syntax-extra"] = {
    loaded = true,
    path = "/home/demaro/.local/share/nvim/site/pack/packer/start/vim-syntax-extra"
  },
