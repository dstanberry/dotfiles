...
vim.o.pumblend = 0 -- opacity for completion menu
vim.o.pumborder = table.concat(ds.icons.border.Default, ",") -- define the default border style of the completion menu.
...
vim.opt.foldexpr = "" -- define the function used to calculate the fold level
