...
M.get = function(c)
  ...
  return {
    ...
    CurSearch                                  = { fg = c.black, bg = c.orange1 },
    IncSearch                                  = { fg = c.black, bg = c.orange1 },
    Substitute                                 = { fg = c.black, bg = c.red1 },
    Search                                     = { fg = c.orange1, underline = true },
    ...
    gitcommitUntracked                         = { fg = c.gray2 },
    gitcommitDiscarded                         = { fg = c.gray2 },
    gitcommitSelected                          = { fg = c.gray2 },
    ...
    WinbarDirectory                            = { fg = ds.color.blend(c.blue0, c.bg2, 0.7), bold = true },
