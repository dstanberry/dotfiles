...
function Object:apply_padding()
  ...
  if l_padding then self.label = ("%s%s"):format(string.rep(" ", l_padding), self.label) end
  if r_padding then self.label = ("%s%s"):format(self.label, string.rep(" ", r_padding)) end
end

function Object:__call(...) return self:new(...) end
