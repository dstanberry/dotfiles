...
function M.send_to_term()
  ...
  vim.api.nvim_create_autocmd("TextChanged", { group = group, buffer = buf, command = "normal! G$" })
  vim.api.nvim_create_autocmd("TermEnter", { group = group, buffer = buf, command = "stopinsert" })
end
