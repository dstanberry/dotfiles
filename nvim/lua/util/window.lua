...
function M.term_scrollback()
  ...
  vim.keymap.set("n", "q", function() vim.cmd.quitall { bang = true } end, { silent = true, buffer = buf })

  vim.api.nvim_create_autocmd("TextChanged", {
    buffer = buf,
    callback = function() vim.cmd.normal { args = { "G$" }, bang = true } end,
  })
