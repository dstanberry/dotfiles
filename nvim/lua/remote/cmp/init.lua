...
groups.new("CmpItemAbbrDefault", { fg = c.white_dark })
groups.new("CmpItemAbbrDeprecatedDefault", { fg = c.white_dark })
...
groups.new("CmpItemKindText", { fg = c.white_dark })
groups.new("CmpItemKindDefault", { fg = c.white_dark })
groups.new("CmpItemKindVariable", { fg = BLUE_LIGHT })

groups.new("CmpBorder", { fg = c.bg_dark, bg = c.bg_dark })
groups.new("CmpFloat", { fg = c.white_dark, bg = c.bg_dark })
