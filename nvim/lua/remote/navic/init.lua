...
groups.new("NavicIconsEnumMember", { fg = c.green })
groups.new("NavicIconsEvent", { fg = c.orange })
groups.new("NavicIconsField", { fg = c.green })
...
groups.new("NavicIconsProperty", { fg = c.green })
groups.new("NavicIconsString", { fg = c.green })
groups.new("NavicIconsStruct", { fg = c.orange })
groups.new("NavicIconsTypeParameter", { fg = c.green })
