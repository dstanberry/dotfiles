...
return {
  {
    ...
    keys = function()
      ...
      return {
        ...
        { "<leader>fe", function() stash.picker.explorer { follow_file = true } end, desc = "picker: toggle explorer" },
        { "<leader>fg", function() Snacks.picker.grep() end, desc = "picker: find in files (grep)" },
        ...
        { ll "fe", function() stash.picker.file_browser() end, desc = "picker: find files relative to buffer" },
        { ll "fg", function() Snacks.picker.grep_buffers() end, desc = "picker: find in buffers (grep)" },
        -- git(hub)
