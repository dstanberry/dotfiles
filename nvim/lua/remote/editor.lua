...
return {
  {
    ...
    init = function()
      groups.new("AerialArrayIcon", { link = "@keyword.storage" })
      ...
      groups.new("AerialFieldIcon", { link = "@variable.member.yaml" })
      ...
      groups.new("AerialKeyIcon", { link = "@variable.member.yaml" })
      groups.new("AerialKeywordIcon", { link = "@keyword" })
      groups.new("AerialMethodIcon", { link = "@function.method" })
      groups.new("AerialModuleIcon", { link = "@keyword.import" })
      groups.new("AerialNamespaceIcon", { link = "@module" })
      ...
      groups.new("AerialPackageIcon", { link = "@keyword.import" })
      groups.new("AerialPropertyIcon", { link = "@variable.member.yaml" })
      groups.new("AerialStringIcon", { link = "@string" })
      groups.new("AerialStructIcon", { link = "@type" })
      groups.new("AerialTypeParameterIcon", { link = "@type" })
      groups.new("AerialVariableIcon", { link = "@variable.member.yaml" })
